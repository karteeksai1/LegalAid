  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f1eee6] text-[#101412]">
      ...
      <main id="top">
        ...
        <section id="access" className="relative overflow-hidden bg-[#d7ff52] py-20 sm:py-28"><div className="absolute right-0 top-0 h-full w-1/3 opacity-20 paper-grid mix-blend-multiply" /><div className="container relative flex flex-col justify-between gap-10 sm:flex-row sm:items-end"><div><span className="eyebrow text-[#3158ff]">Open the case file</span><h2 className="font-display mt-5 max-w-195 text-5xl font-bold leading-[0.9] tracking-[-0.08em] text-[#101412] sm:text-7xl">Make the document defend itself.</h2></div><Button onClick={() => openAuth("/signup")} className="h-14 shrink-0 rounded-none bg-[#101412] px-7 font-mono text-xs uppercase tracking-[0.12em] text-[#d7ff52] hover:bg-[#263026]">Request access <ArrowUpRight className="ml-3 h-4 w-4" /></Button></div></section>
      </main>
