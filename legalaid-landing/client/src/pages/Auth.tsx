  ...
  return (
    <main className="min-h-screen bg-[#101412] text-[#f1eee6]">
      <div className="relative min-h-screen overflow-hidden lg:grid lg:grid-cols-[minmax(420px,0.82fr)_1.18fr]">
        ...
        <section className="relative hidden min-h-screen overflow-hidden lg:block"><div className="absolute inset-0 bg-[#101412]" /><div className="absolute inset-0 bg-cover bg-center opacity-95" style={{ backgroundImage: "url('/manus-storage/legalaid-lady-justice_c94d69fe.png')" }} /><div className="absolute inset-0 bg-[linear-gradient(90deg,#101412ee_0%,transparent_30%,#10141233_100%)]" /><div className="absolute inset-y-0 left-12 border-l border-[#d7ff52]/35" /><div className="absolute bottom-12 left-20 max-w-[360px]"><p className="font-display text-3xl font-semibold leading-[0.98] tracking-[-0.05em] text-[#f1eee6]">The strongest opinion is the one that can show its work.</p></div></section>
      </div>
    </main>
  );
}
