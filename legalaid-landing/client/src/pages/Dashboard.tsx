  ...
  return (
    <main className="min-h-screen bg-[#f1eee6] text-[#101412]">
      ...
      <div className="container py-10 sm:py-14">
        <div className="flex flex-col justify-between gap-8 border-b border-[#d6d2c8] pb-10 lg:flex-row lg:items-end"><div><span className="eyebrow text-[#3158ff]">Review workspace / mock mode</span><h1 className="font-display mt-5 text-5xl font-bold leading-[0.92] tracking-[-0.07em] sm:text-7xl">Good to see you, <span className="text-[#3158ff]">{displayName}.</span></h1><p className="mt-5 max-w-130 text-base leading-7 text-[#626860]">Your evidence-first review workspace is ready. Upload a document to start surfacing what the draft is trying not to say.</p></div><Button onClick={() => toast("Document upload is the next integration.", { description: "This dashboard is currently running on mock authentication." })} className="h-14 rounded-none bg-[#101412] px-7 font-mono text-xs uppercase tracking-[0.12em] text-[#d7ff52] hover:bg-[#263026]"><Plus className="mr-3 h-4 w-4" /> New review</Button></div>

        <section className="mt-10 grid gap-5 lg:grid-cols-[1.3fr_0.7fr]">
          <div className="paper-grid border border-[#d6d2c8] bg-[#f8f6f0] p-7 sm:p-10"><div className="flex items-start justify-between"><div><span className="eyebrow text-[#626860]">Workspace status</span><h2 className="font-display mt-5 text-3xl font-semibold tracking-[-0.05em]">No active reviews yet.</h2><p className="mt-3 max-w-100 text-sm leading-6 text-[#626860]">Start with a contract, policy, or legal document. LegalAid will return a readable trail of findings and supporting context.</p></div><span className="grid h-11 w-11 place-items-center bg-[#d7ff52] text-[#101412]"><FolderOpen className="h-5 w-5" /></span></div><div className="mt-10 flex flex-wrap gap-5 border-t border-[#d6d2c8] pt-5 font-mono text-[10px] uppercase tracking-widest text-[#626860]"><span>OCR ready</span><span>Parallel agents ready</span><span>Evidence guardrails on</span></div></div>
          <div className="bg-[#101412] p-7 text-[#f1eee6] sm:p-8"><div className="flex items-start justify-between"><span className="eyebrow text-[#d7ff52]">System signal</span><ShieldCheck className="h-5 w-5 text-[#d7ff52]" /></div><div className="mt-14 font-display text-6xl font-bold tracking-[-0.08em] text-[#d7ff52]">0<span className="text-2xl text-[#8f978e]"> / 0</span></div><p className="mt-2 text-sm leading-6 text-[#8f978e]">documents reviewed</p><div className="mt-8 border-t border-white/10 pt-5 font-mono text-[10px] uppercase tracking-widest text-[#626b61]">No unsupported findings generated</div></div>
        </section>
